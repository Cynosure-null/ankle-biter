...
class Drivetrain
{
    ...
    */
    ...
    static constexpr units::radians_per_second_squared_t TRAJ_MAX_ANGULAR_ACCELERATION{std::numbers::pi};

    static constexpr auto ROTATE_P = 2; // Modifier for rotational speed -> (degree * ROTATE_P) / 1sec

...
Trajectory::TrajDepends Trajectory::generate_humanplayer_depends()
{
...
units::meter_t Trajectory::determine_desired_y()
{
     ...
     *
     */
    auto current_y = m_odometry.getPose().Y();
    auto lowest = 100.0_m;
    auto lastGood = 0.0_m;
                                                     ...
                                                     )
{
        PathPlannerTrajectory ret_val =
            PathPlanner::generatePath(
                                      ...
                                      PathConstraints(m_drivetrain.TRAJ_MAX_SPEED,
                                                      m_drivetrain.TRAJ_MAX_ACCELERATION),
